...
export default function Badge({ children, variant = 'default' }) {
  const variants = {
    ...
    cerrado_con_faltantes:   'bg-orange-500/20 text-orange-300 border border-orange-500/30',
    perdido:                 'bg-rose-500/20 text-rose-300 border border-rose-500/30',
    faltante:                'bg-rose-500/20 text-rose-300 border border-rose-500/30',
