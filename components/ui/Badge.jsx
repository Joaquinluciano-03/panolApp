...
export default function Badge({ children, variant = 'default' }) {
  const variants = {
    ...
    incompleto:              'bg-cyan-500/20 text-cyan-300 border border-cyan-500/30',
    cerrado_con_faltantes:   'bg-red-500/20 text-red-300 border border-red-500/30',
    perdido:                 'bg-red-500/20 text-red-300 border border-red-500/30',
    faltante:                'bg-red-500/20 text-red-300 border border-red-500/30',
    admin:                   'bg-blue-500/20 text-blue-300 border border-blue-500/30',
    pañolero:                'bg-amber-500/20 text-amber-300 border border-amber-500/30',
    estudiante:              'bg-cyan-500/20 text-cyan-300 border border-cyan-500/30',
