...
/** Humaniza diferencia de tiempo desde una fecha/hora string */
export function tiempoTranscurrido(fechaStr, horaStr) {
...
export function minutosTranscurridos(fechaStr, horaStr) {
